        ...
        <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
            ...
            <form action="ProductServlet" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-lg-12">
                        ...
                        <input type="text" name="nameProduct" id="nameProduct" class="form-control"
                               placeholder="" aria-describedby="helpId112" value="${products.nameProduct}">
                        <small id="helpId112" class="text-muted"></small>
                    </div>
                    <div class="form-group col-lg-12">
                        <label for="title">Title</label>
                        <input type="text" name="title" id="title" class="form-control"
                               placeholder="" aria-describedby="helpId1" value="${products.title}">
                ...
                <div class="d-flex justify-content-around row">
                    <button formaction="ProductServlet/updateProduct?id=${products.id}" class="btn btn-outline-success btn-block">Update
                    </button>
                    <button formaction="ProductServlet/reset" class="btn btn-outline-info btn-block">Cancel</button>
                </div>
            </form>
        </div>
