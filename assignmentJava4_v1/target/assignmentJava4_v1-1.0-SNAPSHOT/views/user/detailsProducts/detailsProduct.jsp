            ...
            <div class="col-sm-8">
                ...
                <div class="col-sm-4">
                    <div class="product-desc">
                        ...
                        <input type="text" value="${products.description}" name="description">
                        <p>${products.description}</p>
                        <div class="size-wrap">
                            <div class="block-26 mb-2">
                                <h4>Size</h4>
                                <ul>
                                    <li class="${products.size == 'S'?'active':''}"><a href="#" class="">S</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-center">
                                <p class="addtocart"><a href="CartServlet/AddToCart?id=${products.id}"
