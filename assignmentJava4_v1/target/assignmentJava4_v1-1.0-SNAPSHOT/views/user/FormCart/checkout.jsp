                ...
                <div class="col-md-12">
                    ...
                    <c:forEach items="${orders}" var="item">
                        <div class="product-cart d-flex">
                            ...
                            <div class="one-eight text-center ml-3">
                                <div class="display-tc">
                                    <h3>${item.color}</h3>
                                </div>
                            </div>
                            ...
                            <div class="one-eight text-center ml-5">
                                <div class="display-tc">
                                    <input type="text" id="quantity" name="quantity"
                                           class="form-control input-number text-center" value="${item.o_quantity}" min="1" max="100">
                                </div>
                            </div>
                            <div class="one-eight text-center">
                                <div class="display-tc">
                            ...
                            <div class="one-eight text-center ml-4">
                                <div class="display-tc">
                                    <a href="remove?id=${item.o_id}" class="closed"></a>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
                            ...
                            <div class="col-sm-8">
                                <form action="CheckoutProductServlet">
                                    <div class="row form-group">
                                        <div class="col-sm-3">
                                            <input type="submit" formaction="CheckoutProductServlet" value="Checkout"
