...
<head>
    ...
    <base href="/CRUD_Lab5_war_exploded/">
</head>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-9">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover table-info text-center sortable">
                        ...
                        <c:forEach items="${list_users}" var="item">
                            <tr>
                                ...
                                <td>
                                    <div class="d-grid gap-2">
                                        <button formaction="UsersServlet/edit?id=${item.id}"
                                                class="btn btn-outline-secondary fw-bold" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal_edit${item.id}">Edit</button>
                            ...
                            <!-- Modal - Update -->
                            <div class="modal fade" id="exampleModal_edit${item.id}" tabindex="-1"
                                            ...
                                            <form action="UsersServlet" method="post"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input name="password" type="password" class="form-control"
                                                           id="input4"
                                                           aria-describedby="emailHelp" value="${item.password}">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="input5" class="form-label">Phone:</label>
                                                    <input name="phone" type="text" class="form-control" id="input5"
                                                           aria-describedby="emailHelp" value="${item.phone}">
                                                </div>
                                                <div class="input-group mb-3">
                                                    <label class="input-group-text"
                                                           for="inputGroupFile01">Avatar: </label>
                                                    <input name="avatar" value="${item.avatar}" type="file"
                                                           class="form-control"
                                                           id="inputGroupFile01">
                                                </div>
                                                <div class="row d-flex justify-content-center justify-content-evenly">
                                                    <button formaction="UsersServlet/update?id=${item.id}"
                                                            class="btn btn-outline-info col-2">Update
                                                    </button>
                                                    <button formaction="UsersServlet/reset"
                                                            class="btn btn-outline-warning col-2">Reset
                                                    </button>
                                                </div>
                                            </form>
                                        </div>
                            ...
                            <div class="modal fade" id="exampleModal2" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="container">
                                            Bạn coá muốn xoá User này không ???
                                        </div>
                                        <div class="modal-footer">
                                            <a href="UsersServlet/delete?id=${item.id}"
                                               class="btn btn-outline-danger fw-bold">Delete</a>
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                                                Close
                                            </button>
            ...
            <div class="row d-flex justify-content-center justify-content-evenly">
                <button class="btn btn-outline-success col-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    Create
                </button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="container">
                            <form action="UsersServlet" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row d-flex justify-content-center justify-content-evenly">
                                    <button formaction="UsersServlet/insert"
